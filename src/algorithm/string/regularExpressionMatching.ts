...
function regularExpressionMatching(string: string, pattern: string): boolean {
  ...
  // Now let's go through every letter of the pattern and every letter of
...
// console.log(regularExpressionMatching('', ''))
// console.log(regularExpressionMatching('a', 'a'))
// console.log(regularExpressionMatching('aa', 'aa'))
// console.log(regularExpressionMatching('aab', 'aab'))
// console.log(regularExpressionMatching('aab', 'aa.'))
// console.log(regularExpressionMatching('aab', '.a.'))
// console.log(regularExpressionMatching('aab', '...'))
// console.log(regularExpressionMatching('a', 'a*'))
// console.log(regularExpressionMatching('aaa', 'a*'))
console.log(regularExpressionMatching('aaab', 'a*b'))
// console.log(regularExpressionMatching('aaabb', 'a*b*'))
// console.log(regularExpressionMatching('aaabb', 'a*b*c*'))
// console.log(regularExpressionMatching('', 'a*'))
// console.log(regularExpressionMatching('xaabyc', 'xa*b.c'))
// console.log(regularExpressionMatching('aab', 'c*a*b*'))
// console.log(regularExpressionMatching('mississippi', 'mis*is*.p*.'))
// console.log(regularExpressionMatching('ab', '.*'))
// console.log(regularExpressionMatching('', 'a'))
// console.log(regularExpressionMatching('a', ''))
// console.log(regularExpressionMatching('aab', 'aa'))
// console.log(regularExpressionMatching('aab', 'baa'))
// console.log(regularExpressionMatching('aabc', '...'))
// console.log(regularExpressionMatching('aaabbdd', 'a*b*c*'))
// console.log(regularExpressionMatching('mississippi', 'mis*is*p*.'))
// console.log(regularExpressionMatching('ab', 'a*'))
// console.log(regularExpressionMatching('abba', 'a*b*.c'))
// console.log(regularExpressionMatching('abba', '.*c'))
